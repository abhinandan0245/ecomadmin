...
const Header = () => {
    ...
    const user = useSelector((state: IRootState) => state.auth.user); // Now from Redux
                ...
                <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                        <Link to="/" className="main-logo flex items-center shrink-0">
                            ...
                            <span className="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle hidden md:inline dark:text-white-light transition-all duration-300">TRILIV</span>
                        </Link>
                        <button
                            type="button"
                    ...
                    <div className="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center space-x-1.5 lg:space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
                        ...
                        {/* <div>
                        <Link to="/auth/login" className="dark:hover:text-white flex">
                        ...
                        <div className="dropdown shrink-0 flex">
                            <Dropdown
                                ...
                                button={<img className="w-9 h-9 rounded-full object-cover saturate-50 group-hover:saturate-100" src={profileImage} alt="userProfile" />}
                            >
                                <ul className="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                                    <li>
                                        <div className="flex items-center px-4 py-4">
                                            <img className="rounded-md w-10 h-10 object-cover" src={user?.profileImage || "/default.png"} alt="userProfile" />
                                    ...
                                    <li>
                                        <Link to="/profile/profile" className="dark:hover:text-white">
                                            <IconUser className="w-4.5 h-4.5 ltr:mr-2 rtl:ml-2 shrink-0" />
                                            Profile
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="/profile/change-password" className="dark:hover:text-white">
                                            <IconUser className="w-4.5 h-4.5 ltr:mr-2 rtl:ml-2 shrink-0" />
                                            Change Password
                                        </Link>
                                    </li>
                ...
                <ul className="horizontal-menu hidden py-1.5 font-semibold px-6 lg:space-x-1.5 xl:space-x-8 rtl:space-x-reverse bg-white border-t border-[#ebedf2] dark:border-[#191e3a] dark:bg-black text-black dark:text-white-dark">
                    ...
                    <li className="menu nav-item relative">
                        ...
                        <ul className="sub-menu">
                            ...
                            <li>
                                <NavLink to="https://triliv.com" target="_blank">
                                    {t('documentation')}
                                </NavLink>
                            </li>
                        </ul>
