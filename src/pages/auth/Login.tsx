                        ...
                        <div className="mx-auto w-full max-w-[440px]">
                            ...
                            <form className="space-y-5 dark:text-white" onSubmit={handleLogin}>
                                ...
                                <div>
                                    ...
                                    <div className="relative text-white-dark">
                                        <input onChange={(e) => setPassword(e.target.value)} value={password} name='password' id="Password" type="password" placeholder="Enter Password" className="form-input ps-10 placeholder:text-white-dark" required/>
                                        <span className="absolute start-4 top-1/2 -translate-y-1/2">
