...
const ContactMessage = () => {
    ...
    const [items, setItems] = useState([
        {
            ...
            Subject: 'Order Issue',
             DateSent: '18/04/2025',
            status: { tooltip: 'Read', color: 'success' },
        ...
        },
        {
            ...
            Subject: 'Feedback',
             DateSent: '18/04/2025',
            status: { tooltip: 'New', color: 'primary' },
            profile: 'profile-1.jpeg',
        },
        {
            id: 4,
        ...
        setInitialRecords(() => {
            return items.filter((item) => {
                return (
                    ...
                    item.DateSent.toLowerCase().includes(search.toLowerCase()) ||
    ...
    return (
        <div className='flex flex-col gap-4'>
            <div className='panel'>
              <p className='text-2xl font-bold w-1/3 '>Contact Message</p>
                ...
                <div className="datatables pagination-padding">
                    <DataTable
                        ...
                        columns={[
                            ...
                            //     render: ({  DateSent, id }) => <div className="text-right font-semibold">{`₹${ DateSent}`}</div>,
                            // },
                            {
                                accessor: 'status',
                                sortable: true,
                                ...
                                render: ({ id }) => (
                                    <div className="flex gap-4 items-center w-max mx-auto">
                                       ...
                                       <button className='btn btn-sm btn-primary'>Mark read</button>
                                        <Tippy content="View">
                                        <NavLink to="/contactsupport/View-Message" className="flex hover:text-primary">
                                            <IconEye />
                                        </NavLink>
                                        </Tippy>
